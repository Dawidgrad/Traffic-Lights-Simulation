            ...
            try
            {
                ...
                while (running)
                {
                    ...
                    for (int i = 0; i < bufferSize - 4; i++)
                    {
                        ...
                        // Changed the order of if statement and incrementation so the value would not
                        // be increased when the array has ended
                        numChars++;
                    }
                    ...
                    String message = remoteIP + " sent " + stringFromServer;                     // Changed to sent by
